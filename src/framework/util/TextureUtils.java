...
public class TextureUtils {
    ...
    public static Texture loadImageAsTexture_UNMODIFIED(GL2 inGL,String inFileName) {
        ...
        try {
            Texture tTexture = TextureIO.newTexture(new FileInputStream(new File(inFileName)),true,null);
            //new BufferedInputStream((new Object()).getClass().getResourceAsStream(inFileName))
    ...
    public static Texture loadImageAsTexture_FLIPPED(GL2 inGL,String inFileName) {
        ...
        try {
            BufferedImage tBufferedImage = ImageIO.read(new FileInputStream(new File(inFileName)));
            //new BufferedInputStream((new Object()).getClass().getResourceAsStream(inFileName)))
